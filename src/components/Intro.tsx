...
export function Intro() {
    ...
    const introAnimation = async () => {
        // Animate #intro-1
        await animate("#intro-1", { opacity: 1 }, { duration: 2, ease: "easeInOut" })
        await animate("#intro-1", { opacity: 0, display: "none" }, { duration: 2, ease: "easeIn" })

        // Animate #intro-2
        await animate("#intro-2", { opacity: 1 }, { duration: 2, delay: stagger(3) })
    ...
    return (
        <div ref={scope} className="flex h-svh flex-col items-center justify-center">
            ...
            >
                ...
                />
                <h1 className="pointer-events-none mt-3 flex justify-center text-3xl text-white">presents</h1>
            </motion.div>
            <motion.div
                initial={{ opacity: 0 }}
                ...
                className="pointer-events-none absolute"
            >
                <h1 className="pointer-events-none mt-3 text-5xl text-white">A Life Of A Bai</h1>
            </motion.div>
            <motion.div
